	...
	<div class="wrapper clearfix">
		<div class="hgroup-wrap">
			...
			<hgroup id="site-logo" class="clearfix">
				...
				<a href="<?php echo get_option('home'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/Logo2.png" border="0" title="MULTIEMPAC - El bueno para sus desechables"></a>
   	...
   	?>
 		...
 		<ul id="MenuMultiempac">
    
		    <li>
		    	<a href="?page_id=20" class="ID_inicio">INICIO</a>
		    </li>
		
		    <li><a href="?page_id=5" class="drop ID_productos">PRODUCTOS</a>
		        ...
		        <div class="dropdown_5columns">
		            ...
		            <div class="col_3">
		            	...
		            	<div class="Producto">
		                	<a href="http://multiempac.com/productos/"><img src="<?php bloginfo('template_directory'); ?>/images/Producto3.png" title="Vasos" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Vasos</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Platos"><img src="<?php bloginfo('template_directory'); ?>/images/Producto2.png" title="Platos y charolas" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Platos y<br>Charolas</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Contenedores"><img src="<?php bloginfo('template_directory'); ?>/images/Producto5.png" title="Contenedores" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Contenedores</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Envases"><img src="<?php bloginfo('template_directory'); ?>/images/Producto4.png" title="Envases" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Envases</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Domos"><img src="<?php bloginfo('template_directory'); ?>/images/Producto6.png" title="Domos, bisagras" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Domos,<br>Bisagras</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Popotes"><img src="<?php bloginfo('template_directory'); ?>/images/Producto7.png" title="Popotes" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Popotes</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Cubiertos"><img src="<?php bloginfo('template_directory'); ?>/images/Producto1.png" title="Cubiertos" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Cubiertos</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Papel"><img src="<?php bloginfo('template_directory'); ?>/images/Producto8.png" title="Papel institucional" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Papel<br>institucional</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Botellas"><img src="<?php bloginfo('template_directory'); ?>/images/Producto9.png" title="Botellas" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Botellas</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Farmaceuticos"><img src="<?php bloginfo('template_directory'); ?>/images/Producto10.png" title="Farmacéuticos" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Farmacéuticos</a>
		                </div>
		                
		                <div class="Producto">
		                	<a href="http://multiempac.com/productos/#_Bolsas"><img src="<?php bloginfo('template_directory'); ?>/images/Producto11.png" title="Bolsas" width="68" height="62" class="img_left imgshadow" border="0" /></a>
		                	<br>
		                	<a href="">Bolsas</a>
		                </div>
		        ...
		        <!-- end dropdown_5columns -->
		        </div>
		    
		    </li>
		    
		    <li>
		    	<a href="?page_id=211" class="ID_marcas">MARCAS</a>
		    </li>
		    
		    <li>
		    	<a href="?page_id=7" class="ID_sucursales">SUCURSALES</a>
		    </li>
		    
		    <li>
		    	<a href="?page_id=9" class="ID_empresa">EMPRESA</a>
		    </li>
		    
		    <li>
		    	<a href="?page_id=11" class="ID_contacto">CONTACTO</a>
		    </li>
		...
		<ul class="primary-nav">
			...
			<li><a href="?page_id=20">Inicio</a></li>
			<li><a href="?page_id=5">Productos</a></li>
			<li><a href="?page_id=211">Marcas</a></li>
			<li><a href="?page_id=7">Sucursales</a></li>
			<li><a href="?page_id=9">Empresa</a></li>
			<li><a href="?page_id=11">Contacto</a></li>
